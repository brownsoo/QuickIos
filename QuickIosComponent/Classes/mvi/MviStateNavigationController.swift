//
//  MviStateNavigationController.swift
//  QuickIosComponent
//
...
open class MviStateNavigationController<V, S, I: MviInteractor<V, S>>: StateNavigationController<S>, ForegroundNotable {
...
extension MviStateNavigationController: AlertPop {
